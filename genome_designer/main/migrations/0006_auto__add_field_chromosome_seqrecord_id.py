...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chromosome.seqrecord_id'
        db.add_column(u'main_chromosome', 'seqrecord_id',
                      self.gf('django.db.models.fields.CharField')(default='seq_id_def', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chromosome.seqrecord_id'
        db.delete_column(u'main_chromosome', 'seqrecord_id')
    ...
    models = {
        ...
        u'main.alignmentgroup': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'5b970e7c'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.chromosome': {
            ...
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'seqrecord_id': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a8d5b236'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.dataset': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'93f29853'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.experimentsample': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'666fe0e3'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.experimentsamplerelation': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'5cedc3eb'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.experimentsampletoalignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'70d47f03'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.project': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ad20e58a'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.referencegenome': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Project']"}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'3e96610a'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.region': {
            ...
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'bb88cb22'", 'unique': 'True', 'max_length': '8'})
        },
        ...
        u'main.savedvariantfilterquery': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'d1c9bf19'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'e6939d2a'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variant': {
            ...
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'375c2105'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.variantalternate': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'80fdab5f'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variantevidence': {
            ...
            'experiment_sample': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ExperimentSample']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'d8a1b5d3'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variantset': {
            ...
            'label': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'dce6bbd8'", 'unique': 'True', 'max_length': '8'}),
