...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferenceGenome.is_materialized_variant_view_valid'
        db.add_column(u'main_referencegenome', 'is_materialized_variant_view_valid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferenceGenome.is_materialized_variant_view_valid'
        db.delete_column(u'main_referencegenome', 'is_materialized_variant_view_valid')
    ...
    models = {
        ...
        u'main.alignmentgroup': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'b100fdc0'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.dataset': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'7a3194b8'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.experimentsample': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'71ad1d2a'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.experimentsampletoalignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'3114c79a'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.project': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'907d0b09'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.referencegenome': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Project']"}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'58d724e9'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.region': {
            ...
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'99103dd8'", 'unique': 'True', 'max_length': '8'})
        },
        ...
        u'main.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'27325b40'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variant': {
            ...
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'467ad3ea'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.variantalternate': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'6d4b3837'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variantevidence': {
            ...
            'experiment_sample': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ExperimentSample']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'5a9d0cb9'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variantset': {
            ...
            'label': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ea9aa72f'", 'unique': 'True', 'max_length': '8'}),
