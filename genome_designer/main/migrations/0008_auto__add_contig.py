...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_contig', (
            ...
            ('uid', self.gf('django.db.models.fields.CharField')(default='4e5b3673', unique=True, max_length=8)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('num_bases', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ...
            ('metadata', self.gf('main.custom_fields.PostgresJsonField')()),
        ))
        db.send_create_signal(u'main', ['Contig'])

        # Adding M2M table for field dataset_set on 'Contig'
        m2m_table_name = db.shorten_name(u'main_contig_dataset_set')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contig', models.ForeignKey(orm[u'main.contig'], null=False)),
            ('dataset', models.ForeignKey(orm[u'main.dataset'], null=False))
        ))
        db.create_unique(m2m_table_name, ['contig_id', 'dataset_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field dataset_set on 'Contig'
        db.delete_table(db.shorten_name(u'main_contig_dataset_set'))
    ...
    models = {
        ...
        u'main.alignmentgroup': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'f51691d5'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.chromosome': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'3578c331'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.contig': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a3fbbf6f'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.dataset': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'7dd0ff83'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.experimentsample': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a73e46c8'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.experimentsamplerelation': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'35af6d74'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.experimentsampletoalignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'628a51fc'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.project': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a6adf408'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.referencegenome': {
            ...
            'metadata': ('main.custom_fields.PostgresJsonField', [], {}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Project']"}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'0bad7705'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.region': {
            ...
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'914327bc'", 'unique': 'True', 'max_length': '8'})
        },
        ...
        u'main.savedvariantfilterquery': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'e78379d5'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'7939a67d'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variant': {
            ...
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'07b7c846'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.variantalternate': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'66d6b571'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variantevidence': {
            ...
            'experiment_sample': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ExperimentSample']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'dee90147'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variantset': {
            ...
            'label': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a4391995'", 'unique': 'True', 'max_length': '8'}),
