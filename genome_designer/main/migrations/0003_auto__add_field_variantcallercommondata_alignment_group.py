...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VariantCallerCommonData.alignment_group'
        db.add_column(u'main_variantcallercommondata', 'alignment_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.AlignmentGroup'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VariantCallerCommonData.alignment_group'
        db.delete_column(u'main_variantcallercommondata', 'alignment_group_id')
    ...
    models = {
        ...
        u'main.alignmentgroup': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'7bd222e8'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.dataset': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a58b187c'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.experimentsample': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'cc05a284'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.experimentsampletoalignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'35bb56c8'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.project': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'081d44b7'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.referencegenome': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Project']"}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'15f2fa73'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.region': {
            ...
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'838dd1f4'", 'unique': 'True', 'max_length': '8'})
        },
        ...
        u'main.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'f5fa5f8f'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variant': {
            ...
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'6ec44f94'", 'unique': 'True', 'max_length': '8'})
        },
        u'main.variantalternate': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'c25d2466'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variantcallercommondata': {
            ...
            'alignment_group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.AlignmentGroup']", 'null': 'True'}),
            'data': ('main.custom_fields.PostgresJsonField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'main.variantevidence': {
            ...
            'experiment_sample': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ExperimentSample']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'4e04240c'", 'unique': 'True', 'max_length': '8'}),
        ...
        u'main.variantset': {
            ...
            'label': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'reference_genome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.ReferenceGenome']"}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'6f1aa1f7'", 'unique': 'True', 'max_length': '8'}),
